...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].specular"), 10.0f, 0.0f, 0.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[2].specular"), 0.0f, 10.0f, 0.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].specular"), 0.0f, 0.0f, 10.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.specular"),50.0f, 0.0f, 0.0f);
